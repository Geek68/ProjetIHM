...
export default function DeleteVirement() {
        ...
        <ModalContent>
          {(onClose) => (
            <>
              ...
              <ModalBody>
                <p>
                  Voulez-vous effacer ce Virement dans l'enregistrement<br/><br/>
                  NB: il n'y a pas de rétour en arrière si le Virement est effacé
                </p>
              </ModalBody>
              <ModalFooter>
