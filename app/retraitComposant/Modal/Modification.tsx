...
export default function ModifcationRetrait() {
          ...
          {(onClose) => (
            <>
              ...
              <ModalBody className="flex flex-row justify-center" >
                    ...
                    <Input size="md"  style={{ color: "#FFFFFF" }} className="Input " variant="underlined" type="number" label={<label style={{ color: 'gray' }}>Montant à tirer*</label>} name="prenom"/>
